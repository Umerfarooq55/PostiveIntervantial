...
// Apply the adapter to the spinner
            ...
            public void onClick(View v) {
                ...
                switch (simState) {
                    case TelephonyManager.SIM_STATE_ABSENT:
                        Toast.makeText(UnfairTreatment.this, "Unable to call", Toast.LENGTH_SHORT).show();
                        break;
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//
                Intent i = new Intent(UnfairTreatment.this, UnfairTreatment.class);
                startActivity(i);
            }
        });
        ...
        if (prefs1.contains("num")) {
            if (prefs.contains(DES)) {
                ...
                //Toast.makeText(UnfairTreatment.this, "no", Toast.LENGTH_SHORT).show();
...
//                .append(" ").append(format));
    ...
    void sendtonext() {
        ...
        if (description.equals("") || time.equals("") || Date.equals("") || nameoff.equals("") || Contrac_code.equals("Select Code...")) {
            Toast.makeText(UnfairTreatment.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();

        } else {

            if (cam && !gal) {
                Intent i = new Intent(UnfairTreatment.this, UnfairTreatmentDetails.class);
                ...
                startActivity(i);
                //.makeText(UnfairTreatment.this, uriSavedImage + "cam", Toast.LENGTH_SHORT).show();
                ...
                // Toast.makeText(UnfairTreatment.this, contentURI + "gal", Toast.LENGTH_SHORT).show();
            } else if (!gal && !cam) {
                Intent i = new Intent(UnfairTreatment.this, UnfairTreatmentDetails.class);
                i.putExtra("desc", description);
                i.putExtra("code", Contrac_code);
                ...
                startActivity(i);
                Toast.makeText(UnfairTreatment.this, "No Pic is attached", Toast.LENGTH_SHORT).show();
            }
    ...
    public void takePhotoFromCamera() {
        ...
        Toast.makeText(UnfairTreatment.this, android.os.Environment.getExternalStorageDirectory().toString(), Toast.LENGTH_LONG).show();
        ...
        if (requestCode == GALLERY) {
            ...
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(UnfairTreatment.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
