...
public class ReportAnInjuryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reportaninjurydetails);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//
                Intent i = new Intent(ReportAnInjuryDetails.this, HomeScreen2.class);
                startActivity(i);
            }
        });
