...
public class ReviewOfSightDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reviewofsightdetails);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//
                Intent i = new Intent(ReviewOfSightDetails.this, HomeScreen2.class);
                startActivity(i);
            }
        });
